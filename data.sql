...
-- Create Issued Fertilizers Table
CREATE TABLE issued_fertilizers (
...
-- Create Farmers Details Table
CREATE TABLE farmers_details (
    id INT AUTO_INCREMENT PRIMARY KEY,
    name VARCHAR(255),
    address VARCHAR(255),
    phone_number VARCHAR(20),
    issued_fertilizer_id INT,
    FOREIGN KEY (issued_fertilizer_id) REFERENCES issued_fertilizers(id)
);
